  ...
  */
    ...
    const ImageElements = this.props.imageUrls.map((image, index) => {
      ...
      if (image.type === 'view') {
        return (
          <ImageZoom
            ...
            pinchToZoom={false}
          >
            {this!.props!.renderImage!({ source: { uri: image.src } })}
          </ImageZoom>
        )
      }
      ...
      const Wrapper = ({ children, ...others }: any) => (
        <ImageZoom
          ...
          handlePanSwipeDown={this.handlePanSwipeDown}
  ...
  public saveToLocal = () => {
    if (!this.props.onSave) {
      if(this.props.imageUrls[this.state.currentShowIndex || 0].src) {
  ...
  public handleSwipeDown = (isSucess: boolean | undefined) => {
